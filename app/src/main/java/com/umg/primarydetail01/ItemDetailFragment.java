...
import com.umg.primarydetail01.databinding.FragmentItemDetailBinding;
...
public class ItemDetailFragment extends Fragment {
     ...
     */
    private UserContent.UserItem mItem;
    ...
    private final View.OnDragListener dragListener = (v, event) -> {
        if (event.getAction() == DragEvent.ACTION_DROP) {
            ...
            mItem = UserContent.ITEM_MAP.get(clipDataItem.getText().toString());
            updateContent();
        }
        return true;
    };
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        getActivity().setTitle("Detalle Perfil");
