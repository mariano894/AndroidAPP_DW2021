...
import com.umg.primarydetail01.databinding.FragmentItemListBinding;
import com.umg.primarydetail01.databinding.ItemListContentBinding;

import com.umg.primarydetail01.placeholder.UserContent;
import com.umg.primarydetail01.ui.login.LoginActivity;
...
public class ItemListFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        String userEmailRetrieved = LoginActivity.user_email;

        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("http://192.168.1.14:80/index2.php/")
                .addConverterFactory(GsonConverterFactory.create(
                        new GsonBuilder().serializeNulls().create()
                ))
                .build();

        SocialNetworkAPIService socialNetworkApiService = retrofit.create(SocialNetworkAPIService.class);
        Call<UserFetchResults> call = socialNetworkApiService.getUser(userEmailRetrieved);

        call.enqueue(new Callback<UserFetchResults>()
        {
            //@RequiresApi(api = Build.VERSION_CODES.N)
            @Override
            public void onResponse(Call<UserFetchResults> call,
                                   Response<UserFetchResults> response)
            {
        ...
        getActivity().setTitle("Social Network DW2021");
    ...
    public void onViewCreated(View view, Bundle savedInstanceState)
    {
        ...
        View.OnClickListener onClickListener = itemView -> {
            UserContent.UserItem item =
                    (UserContent.UserItem) itemView.getTag();
    ...
    public static class SimpleItemRecyclerViewAdapter
        ...
        SimpleItemRecyclerViewAdapter(List<UserContent.UserItem> items,
                                      View.OnClickListener onClickListener,
                                      View.OnContextClickListener onContextClickListener) {
            mValues = items;
        ...
        public void onBindViewHolder(final ViewHolder holder, int position) {
            ...
            holder.itemView.setOnLongClickListener(v -> {
                ...
                ClipData dragData = new ClipData(
                        ((UserContent.UserItem) v.getTag()).content,
